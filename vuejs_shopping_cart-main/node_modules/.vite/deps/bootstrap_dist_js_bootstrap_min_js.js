...
var require_bootstrap_min = __commonJS({
  "node_modules/bootstrap/dist/js/bootstrap.min.js"(exports, module) {
    !function(t, e) {
      ...
      const i = e(t), s = "transitionend", n = (t2) => {
      ...
      }, l = (t2) => !(!t2 || typeof t2 != "object") && (t2.jquery !== void 0 && (t2 = t2[0]), t2.nodeType !== void 0), c = (t2) => l(t2) ? t2.jquery ? t2[0] : t2 : typeof t2 == "string" && t2.length > 0 ? document.querySelector(t2) : null, h = (t2) => {
        if (!l(t2) || t2.getClientRects().length === 0)
          return false;
        ...
        return e2;
      }, d = (t2) => !t2 || t2.nodeType !== Node.ELEMENT_NODE || !!t2.classList.contains("disabled") || (t2.disabled !== void 0 ? t2.disabled : t2.hasAttribute("disabled") && t2.getAttribute("disabled") !== "false"), u = (t2) => {
        ...
        t2.offsetHeight;
      }, f = () => window.jQuery && !document.body.hasAttribute("data-bs-no-jquery") ? window.jQuery : null, p = [], m = () => document.documentElement.dir === "rtl", b = (t2) => {
        var e2;
        e2 = () => {
          const e3 = f();
          if (e3) {
        ...
        return o2 === -1 ? !i2 && s2 ? t2[n2 - 1] : t2[0] : (o2 += i2 ? 1 : -1, s2 && (o2 = (o2 + n2) % n2), t2[Math.max(0, Math.min(o2, n2 - 1))]);
      }, A = /[^.]*(?=\..*)\.|.*/, T = /\..*/, E = /::\d+$/, C = {};
      let k = 1;
      ...
      function P(t2, e2, i2, s2, n2) {
        ...
        const [o2, r2, a2] = N(e2, i2, s2), l2 = S(t2), c2 = l2[a2] || (l2[a2] = {}), h2 = D(c2, r2, o2 ? i2 : null);
        if (h2)
      ...
      function M(t2, e2, i2, s2) {
        ...
        for (const o2 of Object.keys(n2))
          if (o2.includes(s2)) {
            const s3 = n2[o2];
            x(t2, e2, i2, s3.originalHandler, s3.delegationSelector);
          }
      }
      function j(t2) {
      ...
      const $ = { on(t2, e2, i2, s2) {
        ...
        if (typeof e2 != "string" || !t2)
          return;
        const [n2, o2, r2] = N(e2, i2, s2), a2 = r2 !== e2, l2 = S(t2), c2 = e2.startsWith(".");
        if (o2 !== void 0) {
          if (!l2 || !l2[r2])
            return;
          return void x(t2, l2, r2, o2, n2 ? i2 : null);
        }
        if (c2)
        ...
        for (const i3 of Object.keys(h2)) {
          ...
          if (!a2 || e2.includes(s3)) {
            const e3 = h2[i3];
            x(t2, l2, r2, e3.originalHandler, e3.delegationSelector);
          }
        }
      }, trigger(t2, e2, i2) {
        if (typeof e2 != "string" || !t2)
      ...
      } }, F = /* @__PURE__ */ new Map(), H = { set(t2, e2, i2) {
        F.has(t2) || F.set(t2, /* @__PURE__ */ new Map());
        const s2 = F.get(t2);
      ...
      }, get: (t2, e2) => F.has(t2) && F.get(t2).get(e2) || null, remove(t2, e2) {
        if (!F.has(t2))
          return;
        const i2 = F.get(t2);
        i2.delete(e2), i2.size === 0 && F.delete(t2);
      } };
      function z(t2) {
        if (t2 === "true")
          return true;
      ...
      const B = { setDataAttribute(t2, e2, i2) {
        ...
        return e2;
      }, getDataAttribute: (t2, e2) => z(t2.getAttribute(`data-bs-${q(e2)}`)) };
      class W {
        static get Default() {
          return {};
        }
        ...
        _mergeConfigObj(t2, e2) {
          ...
          return __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, this.constructor.Default), typeof i2 == "object" ? i2 : {}), l(e2) ? B.getDataAttributes(e2) : {}), typeof t2 == "object" ? t2 : {});
        }
        _typeCheckConfig(t2, e2 = this.constructor.DefaultType) {
          for (const s2 of Object.keys(e2)) {
            const n2 = e2[s2], o2 = t2[s2], r2 = l(o2) ? "element" : (i2 = o2) == null ? `${i2}` : Object.prototype.toString.call(i2).match(/\s([a-z]+)/i)[1].toLowerCase();
      ...
      $.on(document, "click.bs.button.data-api", Q, (t2) => {
        t2.preventDefault();
        const e2 = t2.target.closest(Q);
        X.getOrCreateInstance(e2).toggle();
      }), b(X);
      const Y = { find: (t2, e2 = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(e2, t2)), findOne: (t2, e2 = document.documentElement) => Element.prototype.querySelector.call(e2, t2), children: (t2, e2) => [].concat(...t2.children).filter((t3) => t3.matches(e2)), parents(t2, e2) {
        const i2 = [];
      ...
      } }, U = { leftCallback: null, rightCallback: null, endCallback: null }, G = { leftCallback: "(function|null)", rightCallback: "(function|null)", endCallback: "(function|null)" };
      class J extends W {
        constructor(t2, e2) {
      ...
      const Z = "next", tt = "prev", et = "left", it = "right", st = "slid.bs.carousel", nt = "carousel", ot = "active", rt = { ArrowLeft: it, ArrowRight: et }, at = { interval: 5e3, keyboard: true, pause: "hover", ride: false, touch: true, wrap: true }, lt = { interval: "(number|boolean)", keyboard: "boolean", ride: "(boolean|string)", pause: "(string|boolean)", touch: "boolean", wrap: "boolean" };
      class ct extends R {
        constructor(t2, e2) {
          super(t2, e2), this._interval = null, this._activeElement = null, this._isSliding = false, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = Y.findOne(".carousel-indicators", this._element), this._addEventListeners(), this._config.ride === nt && this.cycle();
        }
        static get Default() {
          return at;
        }
        ...
        to(t2) {
          ...
          if (t2 > e2.length - 1 || t2 < 0)
            return;
          if (this._isSliding)
            return void $.one(this._element, st, () => this.to(t2));
        ...
        _addEventListeners() {
          this._config.keyboard && $.on(this._element, "keydown.bs.carousel", (t2) => this._keydown(t2)), this._config.pause === "hover" && ($.on(this._element, "mouseenter.bs.carousel", () => this.pause()), $.on(this._element, "mouseleave.bs.carousel", () => this._maybeEnableCycle())), this._config.touch && J.isSupported() && this._addTouchEventListeners();
        }
        _addTouchEventListeners() {
          for (const t3 of Y.find(".carousel-item img", this._element))
            $.on(t3, "dragstart.bs.carousel", (t4) => t4.preventDefault());
          const t2 = { leftCallback: () => this._slide(this._directionToOrder(et)), rightCallback: () => this._slide(this._directionToOrder(it)), endCallback: () => {
        ...
        _setActiveIndicatorElement(t2) {
          ...
          const i2 = Y.findOne(`[data-bs-slide-to="${t2}"]`, this._indicatorsElement);
          i2 && (i2.classList.add(ot), i2.setAttribute("aria-current", "true"));
        }
        _updateInterval() {
        ...
        _slide(t2, e2 = null) {
          if (this._isSliding)
            return;
          const i2 = this._getActive(), s2 = t2 === Z, n2 = e2 || w(this._getItems(), i2, s2, this._config.wrap);
          if (n2 === i2)
            return;
          ...
          n2.classList.add(c2), g(n2), i2.classList.add(l2), n2.classList.add(l2), this._queueCallback(() => {
            n2.classList.remove(l2, c2), n2.classList.add(ot), i2.classList.remove(ot, c2, l2), this._isSliding = false, r2(st);
        ...
        _directionToOrder(t2) {
          return m() ? t2 === et ? tt : Z : t2 === et ? Z : tt;
        }
        _orderToDirection(t2) {
          return m() ? t2 === tt ? et : it : t2 === tt ? it : et;
        }
        static jQueryInterface(t2) {
          return this.each(function() {
      ...
      $.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function(t2) {
        ...
        if (!e2 || !e2.classList.contains(nt))
          return;
        t2.preventDefault();
        const i2 = ct.getOrCreateInstance(e2), s2 = this.getAttribute("data-bs-slide-to");
      ...
      const ht = "show", dt = "collapse", ut = "collapsing", _t = '[data-bs-toggle="collapse"]', gt = { toggle: true, parent: null }, ft = { toggle: "boolean", parent: "(null|element)" };
      class pt extends R {
        constructor(t2, e2) {
          super(t2, e2), this._isTransitioning = false, this._triggerArray = [];
          const i2 = Y.find(_t);
          for (const t3 of i2) {
            const e3 = o(t3), i3 = Y.find(e3).filter((t4) => t4 === this._element);
        ...
        show() {
          ...
          this._queueCallback(() => {
            this._isTransitioning = false, this._element.classList.remove(ut), this._element.classList.add(dt, ht), this._element.style[e2] = "", $.trigger(this._element, "shown.bs.collapse");
        ...
        hide() {
          ...
          this._isTransitioning = true, this._element.style[t2] = "", this._queueCallback(() => {
            this._isTransitioning = false, this._element.classList.remove(ut), this._element.classList.add(dt), $.trigger(this._element, "hidden.bs.collapse");
          }, this._element, true);
        }
        ...
        _getFirstLevelChildren(t2) {
          const e2 = Y.find(":scope .collapse .collapse", this._config.parent);
      ...
      $.on(document, "click.bs.collapse.data-api", _t, function(t2) {
        (t2.target.tagName === "A" || t2.delegateTarget && t2.delegateTarget.tagName === "A") && t2.preventDefault();
        const e2 = o(this), i2 = Y.find(e2);
        for (const t3 of i2)
          pt.getOrCreateInstance(t3, { toggle: false }).toggle();
      }), b(pt);
      const mt = "dropdown", bt = "ArrowUp", vt = "ArrowDown", yt = "click.bs.dropdown.data-api", wt = "keydown.bs.dropdown.data-api", At = "show", Tt = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)', Et = `${Tt}.show`, Ct = ".dropdown-menu", kt = m() ? "top-end" : "top-start", Lt = m() ? "top-start" : "top-end", Ot = m() ? "bottom-end" : "bottom-start", It = m() ? "bottom-start" : "bottom-end", St = m() ? "left-start" : "right-start", Dt = m() ? "right-start" : "left-start", Nt = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: true }, Pt = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", autoClose: "(boolean|string)" };
      class xt extends R {
        constructor(t2, e2) {
          super(t2, e2), this._popper = null, this._parent = this._element.parentNode, this._menu = Y.findOne(Ct, this._parent), this._inNavbar = this._detectNavbar();
        }
        static get Default() {
          return Nt;
        }
          ...
          if (!$.trigger(this._element, "show.bs.dropdown", t2).defaultPrevented) {
            if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))
              for (const t3 of [].concat(...document.body.children))
                $.on(t3, "mouseover", _);
            this._element.focus(), this._element.setAttribute("aria-expanded", true), this._menu.classList.add(At), this._element.classList.add(At), $.trigger(this._element, "shown.bs.dropdown", t2);
          }
        }
        hide() {
          if (d(this._element) || !this._isShown())
        ...
        _completeHide(t2) {
          if (!$.trigger(this._element, "hide.bs.dropdown", t2).defaultPrevented) {
            if ("ontouchstart" in document.documentElement)
              for (const t3 of [].concat(...document.body.children))
                $.off(t3, "mouseover", _);
            this._popper && this._popper.destroy(), this._menu.classList.remove(At), this._element.classList.remove(At), this._element.setAttribute("aria-expanded", "false"), B.removeDataAttribute(this._menu, "popper"), $.trigger(this._element, "hidden.bs.dropdown", t2);
          }
        }
        _getConfig(t2) {
          if (typeof (t2 = super._getConfig(t2)).reference == "object" && !l(t2.reference) && typeof t2.reference.getBoundingClientRect != "function")
        ...
        _createPopper() {
          ...
          this._config.reference === "parent" ? t2 = this._parent : l(this._config.reference) ? t2 = c(this._config.reference) : typeof this._config.reference == "object" && (t2 = this._config.reference);
        ...
        _getPlacement() {
          ...
          return t2.classList.contains("dropup") ? e2 ? Lt : kt : e2 ? It : Ot;
        }
        _detectNavbar() {
        ...
        _getPopperConfig() {
          ...
          return (this._inNavbar || this._config.display === "static") && (B.setDataAttribute(this._menu, "popper", "static"), t2.modifiers = [{ name: "applyStyles", enabled: false }]), __spreadValues(__spreadValues({}, t2), typeof this._config.popperConfig == "function" ? this._config.popperConfig(t2) : this._config.popperConfig);
        }
        _selectMenuItem({ key: t2, target: e2 }) {
          const i2 = Y.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t3) => h(t3));
          i2.length && w(i2, e2, t2 === vt, !i2.includes(e2)).focus();
        }
        static jQueryInterface(t2) {
          return this.each(function() {
        ...
        static clearMenus(t2) {
          ...
          const e2 = Y.find(Et);
          for (const i2 of e2) {
            const e3 = xt.getInstance(i2);
            if (!e3 || e3._config.autoClose === false)
              continue;
            const s2 = t2.composedPath(), n2 = s2.includes(e3._menu);
            if (s2.includes(e3._element) || e3._config.autoClose === "inside" && !n2 || e3._config.autoClose === "outside" && n2)
              continue;
        ...
        static dataApiKeydownHandler(t2) {
          const e2 = /input|textarea/i.test(t2.target.tagName), i2 = t2.key === "Escape", s2 = [bt, vt].includes(t2.key);
          if (!s2 && !i2)
            return;
          if (e2 && !i2)
            return;
          t2.preventDefault();
          const n2 = Y.findOne(Tt, t2.delegateTarget.parentNode), o2 = xt.getOrCreateInstance(n2);
          if (s2)
            return t2.stopPropagation(), o2.show(), void o2._selectMenuItem(t2);
          o2._isShown() && (t2.stopPropagation(), o2.hide(), n2.focus());
        }
      }
      $.on(document, wt, Tt, xt.dataApiKeydownHandler), $.on(document, wt, Ct, xt.dataApiKeydownHandler), $.on(document, yt, xt.clearMenus), $.on(document, "keyup.bs.dropdown.data-api", xt.clearMenus), $.on(document, yt, Tt, function(t2) {
        t2.preventDefault(), xt.getOrCreateInstance(this).toggle();
      }), b(xt);
      const Mt = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", jt = ".sticky-top", $t = "padding-right", Ft = "margin-right";
      class Ht {
        constructor() {
        ...
        hide() {
          ...
          this._disableOverFlow(), this._setElementAttributes(this._element, $t, (e2) => e2 + t2), this._setElementAttributes(Mt, $t, (e2) => e2 + t2), this._setElementAttributes(jt, Ft, (e2) => e2 - t2);
        }
        reset() {
        ...
        _applyManipulationCallback(t2, e2) {
          if (l(t2))
            ...
            for (const i2 of Y.find(t2, this._element))
              e2(i2);
        }
      }
      const zt = "show", qt = "mousedown.bs.backdrop", Bt = { className: "modal-backdrop", isVisible: true, isAnimated: false, rootElement: "body", clickCallback: null }, Wt = { className: "string", isVisible: "boolean", isAnimated: "boolean", rootElement: "(element|string)", clickCallback: "(function|null)" };
      class Rt extends W {
        constructor(t2) {
        ...
        show(t2) {
          ...
          this._config.isAnimated && g(e2), e2.classList.add(zt), this._emulateAnimation(() => {
            v(t2);
          });
        }
        hide(t2) {
        ...
        dispose() {
          this._isAppended && ($.off(this._element, qt), this._element.remove(), this._isAppended = false);
        }
        _getElement() {
          if (!this._element) {
        ...
        _append() {
          ...
          this._config.rootElement.append(t2), $.on(t2, qt, () => {
      ...
      const Vt = ".bs.focustrap", Kt = "backward", Qt = { trapElement: null, autofocus: true }, Xt = { trapElement: "element", autofocus: "boolean" };
      class Yt extends W {
        constructor(t2) {
        ...
        activate() {
          this._isActive || (this._config.autofocus && this._config.trapElement.focus(), $.off(document, Vt), $.on(document, "focusin.bs.focustrap", (t2) => this._handleFocusin(t2)), $.on(document, "keydown.tab.bs.focustrap", (t2) => this._handleKeydown(t2)), this._isActive = true);
        }
        deactivate() {
          this._isActive && (this._isActive = false, $.off(document, Vt));
        }
        _handleFocusin(t2) {
          const { trapElement: e2 } = this._config;
          if (t2.target === document || t2.target === e2 || e2.contains(t2.target))
            return;
          const i2 = Y.focusableChildren(e2);
          i2.length === 0 ? e2.focus() : this._lastTabNavDirection === Kt ? i2[i2.length - 1].focus() : i2[0].focus();
        }
        _handleKeydown(t2) {
          t2.key === "Tab" && (this._lastTabNavDirection = t2.shiftKey ? Kt : "forward");
        }
      }
      const Ut = "hidden.bs.modal", Gt = "show.bs.modal", Jt = "modal-open", Zt = "show", te = "modal-static", ee = { backdrop: true, keyboard: true, focus: true }, ie = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean" };
      class se extends R {
        constructor(t2, e2) {
          super(t2, e2), this._dialog = Y.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = false, this._isTransitioning = false, this._scrollBar = new Ht(), this._addEventListeners();
        }
        static get Default() {
          return ee;
        }
        ...
        show(t2) {
          this._isShown || this._isTransitioning || $.trigger(this._element, Gt, { relatedTarget: t2 }).defaultPrevented || (this._isShown = true, this._isTransitioning = true, this._scrollBar.hide(), document.body.classList.add(Jt), this._adjustDialog(), this._backdrop.show(() => this._showElement(t2)));
        }
        hide() {
          this._isShown && !this._isTransitioning && ($.trigger(this._element, "hide.bs.modal").defaultPrevented || (this._isShown = false, this._isTransitioning = true, this._focustrap.deactivate(), this._element.classList.remove(Zt), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated())));
        }
        dispose() {
        ...
        _showElement(t2) {
          ...
          const e2 = Y.findOne(".modal-body", this._dialog);
          e2 && (e2.scrollTop = 0), g(this._element), this._element.classList.add(Zt), this._queueCallback(() => {
        ...
        _addEventListeners() {
          ...
          }), $.on(this._element, "click.dismiss.bs.modal", (t2) => {
            t2.target === t2.currentTarget && (this._config.backdrop !== "static" ? this._config.backdrop && this.hide() : this._triggerBackdropTransition());
          });
        }
        _hideModal() {
        ...
        _triggerBackdropTransition() {
          ...
          e2 === "hidden" || this._element.classList.contains(te) || (t2 || (this._element.style.overflowY = "hidden"), this._element.classList.add(te), this._queueCallback(() => {
        ...
        static jQueryInterface(t2, e2) {
          return this.each(function() {
            const i2 = se.getOrCreateInstance(this, t2);
            if (typeof t2 == "string") {
              if (i2[t2] === void 0)
                throw new TypeError(`No method named "${t2}"`);
              i2[t2](e2);
      ...
      $.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(t2) {
        const e2 = r(this);
        ["A", "AREA"].includes(this.tagName) && t2.preventDefault(), $.one(e2, Gt, (t3) => {
          t3.defaultPrevented || $.one(e2, Ut, () => {
            h(this) && this.focus();
          });
        });
        const i2 = Y.findOne(".modal.show");
        i2 && se.getInstance(i2).hide(), se.getOrCreateInstance(e2).toggle(this);
      }), V(se), b(se);
      const ne = "show", oe = "showing", re = "hiding", ae = ".offcanvas.show", le = "hidePrevented.bs.offcanvas", ce = "hidden.bs.offcanvas", he = { backdrop: true, keyboard: true, scroll: false }, de = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
      class ue extends R {
        constructor(t2, e2) {
        ...
        show(t2) {
          this._isShown || $.trigger(this._element, "show.bs.offcanvas", { relatedTarget: t2 }).defaultPrevented || (this._isShown = true, this._backdrop.show(), this._config.scroll || new Ht().hide(), this._element.setAttribute("aria-modal", true), this._element.setAttribute("role", "dialog"), this._element.classList.add(oe), this._queueCallback(() => {
            this._config.scroll || this._focustrap.activate(), this._element.classList.add(ne), this._element.classList.remove(oe), $.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: t2 });
          }, this._element, true));
        }
        hide() {
          this._isShown && ($.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = false, this._element.classList.add(re), this._backdrop.hide(), this._queueCallback(() => {
        ...
        _initializeBackDrop() {
          ...
          return new Rt({ className: "offcanvas-backdrop", isVisible: t2, isAnimated: true, rootElement: this._element.parentNode, clickCallback: t2 ? () => {
            this._config.backdrop !== "static" ? this.hide() : $.trigger(this._element, le);
          } : null });
        }
        _initializeFocusTrap() {
          return new Yt({ trapElement: this._element });
        ...
        _addEventListeners() {
          $.on(this._element, "keydown.dismiss.bs.offcanvas", (t2) => {
            t2.key === "Escape" && (this._config.keyboard ? this.hide() : $.trigger(this._element, le));
          });
        }
        static jQueryInterface(t2) {
          return this.each(function() {
            const e2 = ue.getOrCreateInstance(this, t2);
            if (typeof t2 == "string") {
              if (e2[t2] === void 0 || t2.startsWith("_") || t2 === "constructor")
                throw new TypeError(`No method named "${t2}"`);
              e2[t2](this);
      ...
      $.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(t2) {
        ...
        const i2 = Y.findOne(ae);
        i2 && i2 !== e2 && ue.getInstance(i2).hide(), ue.getOrCreateInstance(e2).toggle(this);
      }), $.on(window, "load.bs.offcanvas.data-api", () => {
        for (const t2 of Y.find(ae))
          ue.getOrCreateInstance(t2).show();
      }), $.on(window, "resize.bs.offcanvas", () => {
        for (const t2 of Y.find("[aria-modal][class*=show][class*=offcanvas-]"))
          getComputedStyle(t2).position !== "fixed" && ue.getOrCreateInstance(t2).hide();
      }), V(ue), b(ue);
      const _e = /* @__PURE__ */ new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]), ge = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i, fe = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i, pe = (t2, e2) => {
        const i2 = t2.nodeName.toLowerCase();
        return e2.includes(i2) ? !_e.has(i2) || Boolean(ge.test(t2.nodeValue) || fe.test(t2.nodeValue)) : e2.filter((t3) => t3 instanceof RegExp).some((t3) => t3.test(i2));
      }, me = { "*": ["class", "dir", "id", "lang", "role", /^aria-[\w-]*$/i], a: ["target", "href", "title", "rel"], area: [], b: [], br: [], col: [], code: [], div: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [], img: ["src", "srcset", "alt", "title", "width", "height"], li: [], ol: [], p: [], pre: [], s: [], small: [], span: [], sub: [], sup: [], strong: [], u: [], ul: [] }, be = { extraClass: "", template: "<div></div>", content: {}, html: false, sanitize: true, sanitizeFn: null, allowList: me }, ve = { extraClass: "(string|function)", template: "string", content: "object", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", allowList: "object" }, ye = { selector: "(string|element)", entry: "(string|element|function|null)" };
      class we extends W {
        constructor(t2) {
        ...
        _checkContent(t2) {
          for (const [e2, i2] of Object.entries(t2))
            super._typeCheckConfig({ selector: e2, entry: i2 }, ye);
        }
      ...
      const Ae = /* @__PURE__ */ new Set(["sanitize", "allowList", "sanitizeFn"]), Te = "fade", Ee = "show", Ce = ".modal", ke = "hide.bs.modal", Le = "hover", Oe = "focus", Ie = { AUTO: "auto", TOP: "top", RIGHT: m() ? "left" : "right", BOTTOM: "bottom", LEFT: m() ? "right" : "left" }, Se = { animation: true, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: false, selector: false, placement: "top", offset: [0, 0], container: false, fallbackPlacements: ["top", "right", "bottom", "left"], boundary: "clippingParents", customClass: "", sanitize: true, sanitizeFn: null, allowList: me, popperConfig: null }, De = { animation: "boolean", template: "string", title: "(string|element|function)", trigger: "string", delay: "(number|object)", html: "boolean", selector: "(string|boolean)", placement: "(string|function)", offset: "(array|string|function)", container: "(string|element|boolean)", fallbackPlacements: "array", boundary: "(string|element)", customClass: "(string|function)", sanitize: "boolean", sanitizeFn: "(null|function)", allowList: "object", popperConfig: "(null|object|function)" };
      class Ne extends R {
        constructor(t2, e2) {
          if (i === void 0)
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (s2.append(i2), $.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._createPopper(i2), i2.classList.add(Ee), "ontouchstart" in document.documentElement)
            for (const t3 of [].concat(...document.body.children))
              $.on(t3, "mouseover", _);
          this._queueCallback(() => {
        ...
        hide() {
          ...
          if (t2.classList.remove(Ee), "ontouchstart" in document.documentElement)
            for (const t3 of [].concat(...document.body.children))
              $.off(t3, "mouseover", _);
        ...
        _createTipElement(t2) {
          ...
          if (!e2)
            return null;
          e2.classList.remove(Te, Ee), e2.classList.add(`bs-${this.constructor.NAME}-auto`);
          const i2 = ((t3) => {
            do {
          ...
          return e2.setAttribute("id", i2), this._isAnimated() && e2.classList.add(Te), e2;
        }
        setContent(t2) {
          let e2 = false;
        ...
        _getTemplateFactory(t2) {
          return this._templateFactory ? this._templateFactory.changeContent(t2) : this._templateFactory = new we(__spreadProps(__spreadValues({}, this._config), { content: t2, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
        }
        ...
        _createPopper(t2) {
          const e2 = typeof this._config.placement == "function" ? this._config.placement.call(this, t2, this._element) : this._config.placement, s2 = Ie[e2.toUpperCase()];
          this._popper = i.createPopper(this._element, t2, this._getPopperConfig(s2));
        }
        _getOffset() {
          const { offset: t2 } = this._config;
          return typeof t2 == "string" ? t2.split(",").map((t3) => Number.parseInt(t3, 10)) : typeof t2 == "function" ? (e2) => t2(e2, this._element) : t2;
        ...
        _setListeners() {
          ...
          for (const e2 of t2)
            if (e2 === "click")
              ...
              const t3 = e2 === Le ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), i2 = e2 === Le ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
              $.on(this._element, t3, this._config.selector, (t4) => {
                const e3 = this._initializeOnDelegatedTarget(t4);
                e3._activeTrigger[t4.type === "focusin" ? Oe : Le] = true, e3._enter();
              }), $.on(this._element, i2, this._config.selector, (t4) => {
                const e3 = this._initializeOnDelegatedTarget(t4);
                e3._activeTrigger[t4.type === "focusout" ? Oe : Le] = e3._element.contains(t4.relatedTarget), e3._leave();
              });
            }
          this._hideModalHandler = () => {
            this._element && this.hide();
          }, $.on(this._element.closest(Ce), ke, this._hideModalHandler), this._config.selector ? this._config = __spreadProps(__spreadValues({}, this._config), { trigger: "manual", selector: "" }) : this._fixTitle();
        }
        _fixTitle() {
        ...
        _getConfig(t2) {
          ...
          return t2 = __spreadValues(__spreadValues({}, e2), typeof t2 == "object" && t2 ? t2 : {}), t2 = this._mergeConfigObj(t2), t2 = this._configAfterMerge(t2), this._typeCheckConfig(t2), t2;
        }
        _configAfterMerge(t2) {
          return t2.container = t2.container === false ? document.body : c(t2.container), typeof t2.delay == "number" && (t2.delay = { show: t2.delay, hide: t2.delay }), t2.originalTitle = this._element.getAttribute("title") || "", t2.title = this._resolvePossibleFunction(t2.title) || t2.originalTitle, typeof t2.title == "number" && (t2.title = t2.title.toString()), typeof t2.content == "number" && (t2.content = t2.content.toString()), t2;
        }
        _getDelegateConfig() {
          const t2 = {};
      ...
      b(Ne);
      const Pe = __spreadProps(__spreadValues({}, Ne.Default), { placement: "right", offset: [0, 8], trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }), xe = __spreadProps(__spreadValues({}, Ne.DefaultType), { content: "(null|string|element|function)" });
      class Me extends Ne {
        static get Default() {
          return Pe;
        }
      ...
      b(Me);
      const je = "click.bs.scrollspy", $e = "active", Fe = "[href]", He = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: false, target: null }, ze = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element" };
      class qe extends R {
        constructor(t2, e2) {
        ...
        _maybeEnableSmoothScroll() {
          this._config.smoothScroll && ($.off(this._config.target, je), $.on(this._config.target, je, Fe, (t2) => {
            const e2 = this._observableSections.get(t2.target.hash);
            if (e2) {
              t2.preventDefault();
              const i2 = this._rootElement || window, s2 = e2.offsetTop - this._element.offsetTop;
              if (i2.scrollTo)
                return void i2.scrollTo({ top: s2 });
              i2.scrollTop = s2;
            }
          }));
        }
        ...
        _initializeTargetsAndObservables() {
          ...
          const t2 = Y.find(Fe, this._config.target);
          for (const e2 of t2) {
            if (!e2.hash || d(e2))
              continue;
            const t3 = Y.findOne(e2.hash, this._element);
            h(t3) && (this._targetLinks.set(e2.hash, e2), this._observableSections.set(e2.hash, t3));
          }
        }
        _process(t2) {
          this._activeTarget !== t2 && (this._clearActiveClass(this._config.target), this._activeTarget = t2, t2.classList.add($e), this._activateParents(t2), $.trigger(this._element, "activate.bs.scrollspy", { relatedTarget: t2 }));
        }
        _activateParents(t2) {
          if (t2.classList.contains("dropdown-item"))
            Y.findOne(".dropdown-toggle", t2.closest(".dropdown")).classList.add($e);
          else
            for (const e2 of Y.parents(t2, ".nav, .list-group"))
              for (const t3 of Y.prev(e2, ".nav-link, .nav-item > .nav-link, .list-group-item"))
                t3.classList.add($e);
        }
        _clearActiveClass(t2) {
          t2.classList.remove($e);
          const e2 = Y.find("[href].active", t2);
          for (const t3 of e2)
      ...
      $.on(window, "load.bs.scrollspy.data-api", () => {
        for (const t2 of Y.find('[data-bs-spy="scroll"]'))
          qe.getOrCreateInstance(t2);
      }), b(qe);
      const Be = "ArrowLeft", We = "ArrowRight", Re = "ArrowUp", Ve = "ArrowDown", Ke = "active", Qe = "fade", Xe = "show", Ye = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', Ue = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Ye}`;
      class Ge extends R {
        constructor(t2) {
        ...
        _activate(t2, e2) {
          if (!t2)
            return;
          t2.classList.add(Ke), this._activate(r(t2));
          const i2 = t2.classList.contains(Qe);
          this._queueCallback(() => {
            i2 && t2.classList.add(Xe), t2.getAttribute("role") === "tab" && (t2.focus(), t2.removeAttribute("tabindex"), t2.setAttribute("aria-selected", true), this._toggleDropDown(t2, true), $.trigger(t2, "shown.bs.tab", { relatedTarget: e2 }));
          }, t2, i2);
        }
        _deactivate(t2, e2) {
          if (!t2)
            return;
          t2.classList.remove(Ke), t2.blur(), this._deactivate(r(t2));
          const i2 = t2.classList.contains(Qe);
          this._queueCallback(() => {
            i2 && t2.classList.remove(Xe), t2.getAttribute("role") === "tab" && (t2.setAttribute("aria-selected", false), t2.setAttribute("tabindex", "-1"), this._toggleDropDown(t2, false), $.trigger(t2, "hidden.bs.tab", { relatedTarget: e2 }));
          }, t2, i2);
        }
        _keydown(t2) {
          if (![Be, We, Re, Ve].includes(t2.key))
            return;
          t2.stopPropagation(), t2.preventDefault();
          const e2 = [We, Ve].includes(t2.key), i2 = w(this._getChildren().filter((t3) => !d(t3)), t2.target, e2, true);
          i2 && Ge.getOrCreateInstance(i2).show();
        }
        _getChildren() {
        ...
        _toggleDropDown(t2, e2) {
          ...
          if (!i2.classList.contains("dropdown"))
            return;
          const s2 = (t3, s3) => {
            const n2 = Y.findOne(t3, i2);
            n2 && n2.classList.toggle(s3, e2);
          };
          s2(".dropdown-toggle", Ke), s2(".dropdown-menu", Xe), s2(".dropdown-item", Ke), i2.setAttribute("aria-expanded", e2);
        }
        _setAttributeIfNotExists(t2, e2, i2) {
          t2.hasAttribute(e2) || t2.setAttribute(e2, i2);
        }
        _elemIsActive(t2) {
          return t2.classList.contains(Ke);
        }
        _getInnerElement(t2) {
          return t2.matches(Ue) ? t2 : Y.findOne(Ue, t2);
        }
        _getOuterElement(t2) {
      ...
      $.on(document, "click.bs.tab", Ye, function(t2) {
        ["A", "AREA"].includes(this.tagName) && t2.preventDefault(), d(this) || Ge.getOrCreateInstance(this).show();
      }), $.on(window, "load.bs.tab", () => {
        for (const t2 of Y.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))
          Ge.getOrCreateInstance(t2);
      }), b(Ge);
      const Je = "hide", Ze = "show", ti = "showing", ei = { animation: "boolean", autohide: "boolean", delay: "number" }, ii = { animation: true, autohide: true, delay: 5e3 };
      class si extends R {
        constructor(t2, e2) {
        ...
        static jQueryInterface(t2) {
          return this.each(function() {
            const e2 = si.getOrCreateInstance(this, t2);
            if (typeof t2 == "string") {
              if (e2[t2] === void 0)
                throw new TypeError(`No method named "${t2}"`);
              e2[t2](this);
